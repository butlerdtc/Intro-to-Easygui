"""Version 2 of a timer I made if ever needed
Converts timer_v1.py into a function for use anywhere
...
# Function to run a timer off user input
def timer():
    # Defines statements
    timer_finished = ""
    use_again = ""
    ...
    while True:
        ...
        while True:
            choose_time = easygui.integerbox("What do you want to set "
                                             "the timer to (seconds): ",
                                             "Enter Start Time",
                                             upperbound=100000)
            if choose_time > 0:
                break
            else:
                easygui.msgbox("Please enter positive value for timer",
                               "Error")
